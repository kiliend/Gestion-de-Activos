...
<head>
    ...
    <title>Ver Facturas - Gestion Activos</title>
    ...
    <div class="container mt-4">
        ...
        <form action="FacturaServlet" method="GET">
            <div class="input-group mb-3">
                <input type="text" class="form-control" placeholder="Buscar por cliente o factura" name="facturaBuscar" required>
                ...
                <c:forEach var="factura" items="${facturas}">
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="VerFacturaDetalle.jsp?id=${factura.idFactura}" class="btn btn-info">Ver Detalles</a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
        ...
        <!-- Botón para descargar las facturas -->
        <form action="FacturaServlet" method="POST">
            <button type="submit" class="btn btn-success" name="accion" value="descargar">Descargar Todas las Facturas</button>
        </form>
    </div>
