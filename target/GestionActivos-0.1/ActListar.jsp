...
<head>
    ...
    <title>Ver Activos - Gestion Activos</title>
...
<div id="layoutSidenav">
    <div id="layoutSidenav_nav">
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
            ...
            <h1 class="mb-4">Buscar Activos por Cliente</h1>

            <!-- Formulario de Búsqueda -->
            <form action="ActivoServlet" method="GET">
                <div class="mb-3">
                ...
                <button type="submit" class="btn btn-primary">Buscar Activos</button>
            </form>

            <hr>

            <!-- Tabla de Resultados -->
            <h2 class="mb-4">Activos Asociados</h2>
            <table class="table table-bordered">
                ...
                <tbody>
                    <%-- Obtener la lista de activos desde la solicitud --%>
                    <%
                    ...
                    %>
                                <tr>
                                    <td><%= activo.getNombreActivo() %></td>
                                    <td><%= activo.getDescripcion() %></td>
                                    <td><%= activo.getCantidad() %></td>
                                    <td><%= activo.getValorUnitario() %></td>
                                    <td><%= activo.getCantidad() * activo.getValorUnitario() %></td>
                                </tr>
                    <%
                            }
                        } else {
                    %>
                        <tr>
                            <td colspan="5" class="text-center">No hay activos registrados para este cliente.</td>
                        </tr>
                    <%
                        }
                    %>
