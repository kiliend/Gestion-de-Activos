                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Empresa MOVILPERU S.A. </li>
                        </ol>
...
<body>
    <div class="container mt-5">
        <!-- Tarjeta para la tabla de activos -->
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <table id="datatablesSimple" class="table table-bordered">
                    ...
                    <tbody>
                        <%-- Recibimos la lista de activos del controlador --%>
                        <%
                        ...
                        %>
                                <tr>
                                    <td colspan="5" class="text-center">No hay activos registrados.</td>
                                </tr>
                        <%
                            }
                        %>
