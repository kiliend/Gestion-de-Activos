...
<head>
    ...
    <title>Ver Cotizaciones - Gestion Activos</title>
  ...
  <div class="container mt-4">
        ...
        <form action="CotizacionServlet" method="GET">
            <div class="input-group mb-3">
                <input type="text" class="form-control" placeholder="Buscar por cliente o cotización" name="cotizacionBuscar" required>
        ...
        <c:if test="${empty cotizaciones}">
            <div class="alert alert-warning">No se encontraron cotizaciones.</div>
        </c:if>
                ...
                <c:forEach var="cotizacion" items="${cotizaciones}">
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="VerCotizacionDetalle.jsp?id=${cotizacion.idCotizacion}" class="btn btn-info">Ver Detalles</a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
        ...
        <!-- Botón para descargar las cotizaciones -->
        <form action="CotizacionServlet" method="POST">
            <button type="submit" class="btn btn-success" name="accion" value="descargar">Descargar Todas las Cotizaciones</button>
        </form>
    </div>
