...
<head>
    ...
    <title>Registrar Cotización - Gestion Activos</title>
...
<div id="layoutSidenav">
                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Gestión de Cotizaciones</h1>
                            <ol class="breadcrumb mb-4">
                                <li class="breadcrumb-item active">Registrar Cotización</li>
                            </ol>
  ...
  <div class="container mt-5">
            ...
            <form action="CotizacionServlet" method="POST">
                <!-- Campo oculto para identificar acción (registrar cotización) -->
