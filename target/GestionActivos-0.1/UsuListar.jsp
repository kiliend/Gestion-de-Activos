...
<head>
    ...
    <title>Ver Usuarios - Gestion Activos</title>
...
<div class="card mb-4">
    <div class="card-header">
        <i class="fas fa-search me-1"></i>Búsqueda de Usuario
    </div>
    <div class="card-body">
        <form action="UsuarioServlet" method="GET">
            <div class="mb-3">
                <label for="nombreBuscar" class="form-label">Nombre del Usuario</label>
                <input type="text" class="form-control" id="nombreBuscar" name="nombre" placeholder="Buscar por nombre" required>
            </div>
             ...
             <div class="card mb-4">
                ...
                <div class="card-body">
                    <table id="datatablesSimple" class="table table-bordered">
                        ...
                        <tbody>
                            <%-- Obtener la lista de usuarios desde el atributo de la solicitud --%>
                            <%
                            ...
                            %>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="UsuarioServlet?accion=editar&id=<%= usuario.getIdUsuario() %>" class="btn btn-warning btn-sm">Editar</a>
                                                <a href="UsuarioServlet?accion=eliminar&id=<%= usuario.getIdUsuario() %>" class="btn btn-danger btn-sm">Eliminar</a>
                                            </td>
                                        </tr>
                            <%
                                    }
