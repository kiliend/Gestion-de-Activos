...
<head>
    ...
    <title>Registrar Activo - Gestion Activos</title>
...
<div id="layoutSidenav">
        ...
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
           ...
           <script>
            ...
            function agregarActivo() {
                ...
                fila.innerHTML = `
                    <td><input type="text" name="nombreActivo[]" class="form-control" required></td>
                    ...
                    <td><input type="number" name="valorUnitario[]" class="form-control" step="0.01" required></td>
    ...
    <body>
        <div class="container mt-5">
            <h1 class="mb-4">Registrar Gestión y Activos</h1>

            <!-- Formulario de Gestión y Activos -->
            <form action="GestionActivoServlet" method="POST">
                <!-- Campo oculto para identificar acción -->
                <input type="hidden" name="accion" value="registrar">

                <!-- Datos de la Gestión -->
                <h3>Datos de la Gestión</h3>
                <div class="mb-3">
                    <label for="idUsuario" class="form-label">Usuario Encargado</label>
                ...
                <div class="mb-3">
                    <label for="idFactura" class="form-label">Factura Asociada</label>
                ...
                <button type="button" class="btn btn-secondary mb-3" onclick="agregarActivo()">Agregar Activo</button>

                <button type="submit" class="btn btn-primary">Registrar Gestión y Activos</button>
            </form>
        </div>
