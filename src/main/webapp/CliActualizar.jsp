...
<head>
    ...
    <title>Actualizar Cliente - Gestion Activos</title>
...
<div id="layoutSidenav">
    ...
    <div class="container mt-4">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <!-- Se iteran los clientes encontrados -->
                <c:forEach var="cliente" items="${clientes}">
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="ActualizarCliente.jsp?id=${cliente.idCliente}" class="btn btn-warning">Actualizar</a>
                            <!-- Botón para eliminar -->
                            <a href="ClienteServlet?accion=eliminar&id=${cliente.idCliente}" class="btn btn-danger" onclick="return confirm('¿Estás seguro de eliminar este cliente?')">Eliminar</a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
