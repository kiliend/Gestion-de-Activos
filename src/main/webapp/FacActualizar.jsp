...
<head>
    ...
    <title>Actualizar Factura - Gestion Activos</title>
...
<div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                            <h1 class="mt-4">Gestión de Facturas</h1>
                            <ol class="breadcrumb mb-4">
                                <li class="breadcrumb-item active">Actualizar Factura</li>
                            </ol>
 ...
 <div class="container mt-4">
        ...
        <!-- Barra de búsqueda por ID de factura -->
        <form action="FacturaServlet" method="GET">
            <div class="input-group mb-3">
                <input type="text" class="form-control" placeholder="Buscar por ID de factura" name="facturaId" required>
                <button class="btn btn-primary" type="submit">Buscar</button>
            </div>
        </form>

        <!-- Formulario para actualizar factura (si la factura está encontrada) -->
        <c:if test="${not empty factura}">
            <form action="FacturaServlet" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="cliente" name="cliente" value="${factura.clienteNombre}" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="estado" name="estado" required>
                        <option value="emitida" <c:if test="${factura.estado == 'emitida'}">selected</c:if>>Emitida</option>
                        <option value="pagada" <c:if test="${factura.estado == 'pagada'}">selected</c:if>>Pagada</option>
                        <option value="anulada" <c:if test="${factura.estado == 'anulada'}">selected</c:if>>Anulada</option>
                    </select>
                </div>
